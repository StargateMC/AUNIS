...
public class StargateOrlinMergeHelper extends StargateAbstractMergeHelper {
	...
	public static final BlockMatcher BASE_MATCHER = null;//BlockMatcher.forBlock(AunisBlocks.STARGATE_ORLIN_BASE_BLOCK);
	public static final BlockMatcher MEMBER_MATCHER = null;//BlockMatcher.forBlock(AunisBlocks.STARGATE_ORLIN_MEMBER_BLOCK);
	...
	public Block getMemberBlock() {
		return null;//AunisBlocks.STARGATE_ORLIN_MEMBER_BLOCK;
	}
