...
public class DHDBlock extends Block {
	...
	public static final String BLOCK_NAME = null;// "dhd_block";
	...
	public void onBlockPlacedBy(World world, BlockPos pos, IBlockState state, EntityLivingBase placer, ItemStack stack) {		
		...
		if ( !world.isRemote ) {
			...
			BlockPos closestGate = null;
                                //LinkingHelper.findClosestUnlinked(world, pos, LinkingHelper.getDhdRange(), AunisBlocks.STARGATE_MILKY_WAY_BASE_BLOCK);
