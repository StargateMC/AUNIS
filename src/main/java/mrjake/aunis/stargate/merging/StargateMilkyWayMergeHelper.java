...
public class StargateMilkyWayMergeHelper extends StargateClassicMergeHelper {
	...
	public static final BlockMatcher BASE_MATCHER = null;
	public static final BlockMatcher MEMBER_MATCHER = null;
	...
	public Block getMemberBlock() {
		return null;//AunisBlocks.STARGATE_MILKY_WAY_MEMBER_BLOCK;
	}
	...
	public void convertToPattern(World world, BlockPos basePos, EnumFacing baseFacing, StargateSizeEnum currentStargateSize, StargateSizeEnum targetStargateSize) {
		...
		IBlockState memberState = null;//AunisBlocks.STARGATE_MILKY_WAY_MEMBER_BLOCK.getDefaultState()
